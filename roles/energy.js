                        ...
                        >
                          <span class="tools-filters-toggle__icon tools-grouping-toggle__icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24" focusable="false">
                              <path d="M4.75 5.5A1.75 1.75 0 0 1 6.5 3.75h3.32c.7 0 1.36.33 1.78.88l.56.74c.14.18.35.29.58.29h4.76a1.75 1.75 0 0 1 1.75 1.75V8h-3.5A1.75 1.75 0 0 0 14 9.75v3a1.75 1.75 0 0 0 1.75 1.75h3.5v2A1.75 1.75 0 0 1 17.5 18.25h-11A1.75 1.75 0 0 1 4.75 16.5v-11Zm10.75 4a.75.75 0 0 0-.75.75v2.5c0 .41.34.75.75.75H18c.41 0 .75-.34.75-.75v-2.5a.75.75 0 0 0-.75-.75h-2.5Z" />
                            </svg>
                          </span>
                        </button>
              ...
              <div class="tools-controls">
                ...
                >
                  ...
                  <label class="tools-filter">
                    ...
                    <select
                      class="form-input"
                      data-no-photo-filter="manufacturer"
                    ></select>
                  </label>
                  <label class="tools-filter">
                    <span>Модель</span>
