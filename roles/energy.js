        ...
        <div class="settings-modal info-moves-history-modal is-hidden" data-info-moves-history-modal>
          ...
          >
            <div class="settings-modal__header info-moves-history-modal__header">
              ...
              <button
                class="button-icon info-moves-history-modal__close"
                type="button"
            ...
            <div class="settings-modal__body info-moves-history-modal__body">
              <div class="info-moves-history-toolbar">
                <div class="info-moves-history-toolbar__top">
                  <label class="tools-search info-moves-history-search" aria-label="Поиск по истории перемещений">
                    <input class="form-input tools-search__input info-moves-history-search__input" type="search" placeholder="Поиск: номер, бух.номер, инструмент, пользователь..." data-info-moves-history-search autocomplete="off" />
                  </label>
