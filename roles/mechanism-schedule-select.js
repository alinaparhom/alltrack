...
export const setupMechanismScheduleSelects = (container) => {
  ...
  container.addEventListener("click", (event) => {
    ...
    if (option) {
      ...
      input.value = option.dataset.mechanismScheduleOption;
